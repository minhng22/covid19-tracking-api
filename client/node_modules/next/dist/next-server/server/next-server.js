...
class Server {
        ...
        if (this.customRoutes) {
            ...
            redirects = this.customRoutes.redirects.map(redirect => {
                ...
                return {
                    ...
                    fn: async (_req, res, params, _parsedUrl) => {
                        const { parsedDestination } = router_1.prepareDestination(route.destination, params, true);
            ...
            rewrites = this.customRoutes.rewrites.map(rewrite => {
                ...
                return {
                    ...
                    match: route.match,
                    fn: async (req, res, params, _parsedUrl) => {
                        const { newUrl, parsedDestination } = router_1.prepareDestination(route.destination, params);
    ...
    async renderToHTMLWithComponents(req, res, pathname, { components, query }, opts) {
        ...
        const urlPathname = url_1.parse(req.url || '').pathname;
