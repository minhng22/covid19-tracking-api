...
function buildModelDefinition(target, def) {
    ...
    const propertyMap = (_a = context_1.MetadataInspector.getAllPropertyMetadata(exports.MODEL_PROPERTIES_KEY, prototype)) !== null && _a !== void 0 ? _a : {};
    ...
    const relationMeta = (_b = context_1.MetadataInspector.getAllPropertyMetadata(relation_decorator_1.RELATIONS_KEY, prototype)) !== null && _b !== void 0 ? _b : {};
    const relations = {};
