...
class ModelMetadataHelper {
    ...
    static getModelMetadata(target, options) {
        const classDef = context_1.MetadataInspector.getClassMetadata(model_decorator_1.MODEL_WITH_PROPERTIES_KEY, target, Object.assign(Object.assign({}, options), { ownMetadataOnly: true }));
